package josehomenhuck.backend.job;
...
import josehomenhuck.backend.entity.TipoTransacao;
import josehomenhuck.backend.entity.Transacao;
import josehomenhuck.backend.entity.TransacaoCNAB;
...
public class BatchConfig {
  ...
  ItemProcessor<TransacaoCNAB, Transacao> processor() {
    return item -> {
      ...
      var valorTratado = item.valor()
                      .divide(BigDecimal.valueOf(100))
                      .multiply(tipoTransacao.getSinal());

      var transacao = new Transacao(
        null, item.tipo(), null, valorTratado,
